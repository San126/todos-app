                ...
                <div className="home">
                    ...
                    <Row className="cards">
                        <Col md={4}>
                            <Card className='add'>
                                <CardBody>
                                    <Button className="addButton" onClick={handleVisibility} title="add new project">
                        ...
                        <Col md={4}>
                            <Card className='prolist'>
                                <CardBody>
                                    <Button className="prolistButton" onClick={handleListVisibility} title="project list">
                        ...
                        <Col md={4}>
                            <Card className='project'>
                                <CardBody>
                                    <DropdownButton className="projectButton" id="dropdown-basic-button" title={<FontAwesomeIcon icon={faFolderOpen} title='project details' />}>
